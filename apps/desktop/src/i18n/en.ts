...
export const en: Translations = {
  ...
  updates: {
    ...
    nixPackageTitle: 'Nix package details',
    nixPackageBody: 'This immutable Nix package updates through your Nix profile, NixOS configuration, or flake — not from the desktop self-updater.',
    nixVersion: 'Version',
    nixBaseVersion: 'Release version',
    nixBranch: 'Branch',
    nixCommit: 'Commit',
    nixDirty: 'This package was built from a dirty source tree.',
    nixViewCommit: 'View this commit on GitHub',
