...
export const zh: Translations = {
  ...
  updates: {
    ...
    nixPackageTitle: 'Nix 软件包详情',
    nixPackageBody: '此不可变 Nix 软件包需通过你的 Nix profile、NixOS 配置或 flake 更新，不能在桌面应用内更新。',
    nixVersion: '版本',
    nixBaseVersion: '发布版本',
    nixBranch: '分支',
    nixCommit: '提交',
    nixDirty: '此软件包从有未提交更改的源代码树构建。',
    nixViewCommit: '在 GitHub 查看此提交',
