...
export const zhHant = defineLocale({
  ...
  updates: {
    ...
    nixPackageTitle: 'Nix 套件詳細資料',
    nixPackageBody: '此不可變 Nix 套件需透過你的 Nix profile、NixOS 設定或 flake 更新，不能在桌面應用程式內更新。',
    nixVersion: '版本',
    nixBaseVersion: '發行版本',
    nixBranch: '分支',
    nixCommit: '提交',
    nixDirty: '此套件從有未提交變更的來源樹建置。',
    nixViewCommit: '在 GitHub 檢視此提交',
