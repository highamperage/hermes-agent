...
export const ja = defineLocale({
  ...
  updates: {
    ...
    nixPackageTitle: 'Nix パッケージの詳細',
    nixPackageBody: 'この不変の Nix パッケージは、デスクトップ更新機能ではなく Nix profile、NixOS 設定、または flake から更新します。',
    nixVersion: 'バージョン',
    nixBaseVersion: 'リリースバージョン',
    nixBranch: 'ブランチ',
    nixCommit: 'コミット',
    nixDirty: 'このパッケージは変更のあるソースツリーからビルドされました。',
    nixViewCommit: 'GitHub でこのコミットを表示',
